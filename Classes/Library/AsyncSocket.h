...
@property (getter=getCFReadStream, setter=setCFReadStream:) CFReadStreamRef theReadStream;
@property (getter=getCFWriteStream, setter=setCFWriteStream:) CFWriteStreamRef theWriteStream;
@property CFRunLoopSourceRef theSource4;
@property CFRunLoopSourceRef theSource6;
@property CFRunLoopRef theRunLoop;
@property (retain,getter=runLoopModes, setter=setRunLoopModes:) NSArray *theRunLoopModes;
@property (retain) NSTimer *theConnectTimer;
@property (retain) NSMutableArray *theReadQueue;
@property (retain) AsyncReadPacket *theCurrentRead;
@property (retain) NSTimer *theReadTimer;
@property (retain) NSMutableData *partialReadBuffer;
@property (retain) NSMutableArray *theWriteQueue;
@property (retain) AsyncWritePacket *theCurrentWrite;
@property (retain) NSTimer *theWriteTimer;
@property (assign,getter=delegate,setter=setDelegate:) id theDelegate;
@property UInt16 theFlags;
@property (getter=userData,setter=setUserData:) long theUserData;
