...
#define TREE_MIN_CELL_WIDTH		140.0
...
- (void)outlineView:(NSOutlineView *)outlineView willDisplayCell:(ServerListCell *)cell forTableColumn:(NSTableColumn *)tableColumn item:(id)item
{
}
