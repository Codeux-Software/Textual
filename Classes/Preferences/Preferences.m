...
+ (BOOL)usesModernUserInterface
{
	return [_NSUserDefaults() boolForKey:@"ModernUIDesign"];
}
...
+ (BOOL)usesPredeterminedFonts
{
	return [_NSUserDefaults() boolForKey:@"Preferences.Theme.predetermine_fonts"];
}
...
{
	return [_NSUserDefaults() objectForKey:@"Preferences.Theme.member_list_font_name"];
}

+ (void)setThemeMemberListFontName:(NSString *)value
{
	[_NSUserDefaults() setObject:value forKey:@"Preferences.Theme.member_list_font_name"];
}

+ (NSString *)themeChannelListFontName
{
	return [_NSUserDefaults() objectForKey:@"Preferences.Theme.channel_list_font_name"];
}

+ (void)setThemeChannelListFontName:(NSString *)value
{
	[_NSUserDefaults() setObject:value forKey:@"Preferences.Theme.channel_list_font_name"];
}

+ (NSString *)themeInputBoxFontName
{
	return [_NSUserDefaults() objectForKey:@"Preferences.Theme.input_box_font_name"];
}

+ (void)setThemeInputBoxFontName:(NSString *)value
{
	[_NSUserDefaults() setObject:value forKey:@"Preferences.Theme.input_box_font_name"];
}

+ (void)setThemeMemberListFontSize:(NSDoubleN)value
{
	[_NSUserDefaults() setDouble:value forKey:@"Preferences.Theme.member_list_font_size"];
}

+ (NSDoubleN)themeMemberListFontSize
{
	return [_NSUserDefaults() doubleForKey:@"Preferences.Theme.member_list_font_size"];
}

+ (void)setThemeChannelListFontSize:(NSDoubleN)value
{
	[_NSUserDefaults() setDouble:value forKey:@"Preferences.Theme.channel_list_font_size"];
}

+ (NSDoubleN)themeInputBoxFontSize
{
	return [_NSUserDefaults() doubleForKey:@"Preferences.Theme.input_box_font_size"];
}

+ (void)setThemeInputBoxFontSize:(NSDoubleN)value
{
	[_NSUserDefaults() setDouble:value forKey:@"Preferences.Theme.input_box_font_size"];
}

+ (NSDoubleN)themeChannelListFontSize
{
	return [_NSUserDefaults() doubleForKey:@"Preferences.Theme.channel_list_font_size"];
}
...
+ (void)initPreferences
{
	...
	[d setObject:DEFAULT_TEXTUAL_FONT			forKey:@"Preferences.Theme.member_list_font_name"];
	[d setObject:DEFAULT_TEXTUAL_FONT			forKey:@"Preferences.Theme.channel_list_font_name"];
	[d setObject:DEFAULT_TEXTUAL_FONT			forKey:@"Preferences.Theme.input_box_font_name"];
	...
	[d setDouble:10.0 forKey:@"Preferences.Theme.member_list_font_size"];
	[d setDouble:10.0 forKey:@"Preferences.Theme.channel_list_font_size"];
	[d setDouble:13.0 forKey:@"Preferences.Theme.input_box_font_size"];
	...
	if ([NSFont fontIsAvailable:[Preferences themeMemberListFontName]] == NO) {
		[_NSUserDefaults() setObject:DEFAULT_TEXTUAL_FONT forKey:@"Preferences.Theme.member_list_font_name"];
	}
	
	if ([NSFont fontIsAvailable:[Preferences themeChannelListFontName]] == NO) {
		[_NSUserDefaults() setObject:DEFAULT_TEXTUAL_FONT forKey:@"Preferences.Theme.channel_list_font_name"];
	}
	
	if ([NSFont fontIsAvailable:[Preferences themeInputBoxFontName]] == NO) {
		[_NSUserDefaults() setObject:DEFAULT_TEXTUAL_FONT forKey:@"Preferences.Theme.input_box_font_name"];
	}
